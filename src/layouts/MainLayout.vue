<template>
  <v-app class="bg-slate-50">
    ...
    >
      <div class="px-6 py-8 border-b border-white/10">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h2
              class="text-xl font-black tracking-widest text-white leading-none"
            >
              AECURATE
            </h2>
            <p
              class="text-[10px] text-blue-300 font-bold tracking-widest mt-1 uppercase"
            >
              Logistik UM 2026
            </p>
          </div>
      ...
      <div class="px-3 py-4">
        <p
          class="px-3 text-xs font-bold text-slate-500 uppercase tracking-wider mb-2"
        >
          Menu Utama
        </p>
        <v-list nav class="p-0">
          ...
          <!-- MENU TRANSAKSI (GLOBAL: Bisa diakses Admin & Crew) -->
    ...
    <v-app-bar
      elevation="0"
      class="border-b border-slate-200 bg-white/80 backdrop-blur-md"
    >
      <v-app-bar-nav-icon
        @click="drawer = !drawer"
        color="slate-700"
      ...
      <v-breadcrumbs
        :items="['Pusat Kendali', 'Dashboard']"
        class="text-sm font-semibold text-slate-600 hidden sm:flex"
      >
      ...
      <!-- Toggle Status -->
      <div
        class="hidden md:flex items-center gap-3 mr-6 bg-slate-100 py-1.5 px-4 rounded-full border border-slate-200"
      >
        <div
        ...
        <span
          ...
          :class="isAvailable ? 'text-green-700' : 'text-red-600'"
        >
